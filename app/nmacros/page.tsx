...
export default function Macros() {
  ...
  if (toolOutput?.result?.structuredContent) {
    ...
    } else if ('foodDescription' in toolOutput && !('loggedMeals' in toolOutput)) {
      // Only foodDescription present - ChatGPT hasn't generated meal data yet
      // This is the issue we're seeing
      console.warn("Only foodDescription received, meal data not generated by ChatGPT");
    }
  }
  ...
  if (meals.length === 0) {
    const hasFoodDescription = toolOutput && 'foodDescription' in toolOutput;
      ...
      <div className="min-h-screen bg-white text-black font-sans p-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-gray-500 text-center mb-4">
            {hasFoodDescription 
              ? "ChatGPT received the food description but hasn't generated meal data yet. The tool may need to be called again or the analysis is in progress."
